...
% LAST MODIFIED: November 5, 2004 by gwyneth
...
%         y = vert_marg + (15 - i)*(h_edit + vert_btwn);
    ...
    if s_max - s_min < 10
        s_step(1) = 0.01/(s_max - s_min );
        s_step(2) = 0.1/(s_max - s_min );
    end
    ...
    uicontrol(...
        ...
        'UserData',i,...
        'Callback','obj_control_callback(''param_slider_callback'')'...
        );
    ...
    uicontrol(...
        ...
        'FontSize',10,...
        'FontWeight','normal',...
        'String',num2str(data.kine.(cur_obj).data.params(i,frame),3),...
        'UserData',i,...
        'Callback','obj_control_callback(''param_edit_callback'')'...
        );
