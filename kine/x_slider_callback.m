...
% 
% Description:    This function is called when the slider for the x axis
...
slider_value = get(data.handles.x_slider,'Value');
set(data.handles.x_edit,'String',slider_value);
