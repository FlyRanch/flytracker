% Function:       y_edit_callback
% 
% Description:    This function is called when the edit box for the y axis
...
edit_value = str2num(get(data.handles.y_edit,'String'));
set(data.handles.y_slider,'Value',edit_value);
