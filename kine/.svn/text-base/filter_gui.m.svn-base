...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_LayoutFcn',  @filter_gui_LayoutFcn, ...
                   'gui_Callback',   []);
...
elseif (end_frame > data.images.frames)
    ...
    filter_data(start_frame, end_frame);
    delete(gcf)
end
...
function h1 = filter_gui_LayoutFcn(policy)
...
'singleton', 1, ...
'syscolorfig', 1, ...
'lastSavedFile', 'C:\Documents and Settings\Qing\Desktop\filter_gui.m'));
...
'Callback','filter_gui(''txtStartFrame_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[9.8 7.53846153846154 20.2 1.61538461538462],...
'String','',...
'Style','edit',...
'CreateFcn','filter_gui(''txtStartFrame_CreateFcn'',gcbo,[],guidata(gcbo))',...
'Tag','txtStartFrame');
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Callback','filter_gui(''txtEndFrame_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[39.8 7.53846153846154 20.2 1.61538461538462],...
'String','',...
'Style','edit',...
'CreateFcn','filter_gui(''txtEndFrame_CreateFcn'',gcbo,[],guidata(gcbo))',...
'Tag','txtEndFrame');
...
'Parent',h1,...
'Units','characters',...
'Callback','filter_gui(''btnOK_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
...
'Parent',h1,...
'Units','characters',...
'Callback','filter_gui(''btnCancel_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
...
elseif numargin > 3 & ischar(varargin{1}) & ishandle(varargin{2})
    % filter_GUI('CALLBACK',hObject,eventData,handles,...)
    gui_Create = 0;
else
    % filter_GUI(...)
