...
data.types = get_types('C:\MATLAB6p5\work\Kine_v2_1');%data.setup.mfile_path);
...
set(data.handles.get_kinematics, 'visible','on')
set(data.handles.obj_controls,'visible','on')
