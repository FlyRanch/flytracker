% Function SHOW_BCVIEWS
%
% CALLING FUNCTION: Controller menu
% ACTIONS: Opens dialog to choose axes for determinig body-centered view
...
% Check to see if a bc field already exists
if isfield(data,'bc')

    isbc = questdlg('You have already chosen Body-Centered axes.  Delete previous choices?',...
        'Body-Centered views alredy chosen',...
        'Yes','Hide body-centered view','Cancel','Cancel');
...
switch isbc
    ...
    case 'Hide body-centered view'
        % Make BC views invisible
        if isfield(dig_data.handles,'bc_view')
            set(dig_data.handles.bc_view,'Visible','off')
        end
    case 'Yes'
        ...
        bc_obj_text = uicontrol(...
            ...
            'FontWeight','normal',...
            'HorizontalAlignment','right',...
            'String','OR center on object:'...
            );
        
        bc_obj_menu = uicontrol(...
            'Style','popupmenu',...
            'Tag','bc_obj_menu',...
            'Units','characters',...
            'Position',[27 4 18 1.75],...
            'BackgroundColor','y',...
            'FontName','Helvetica',...
            'FontUnits','points',...
            'FontSize',10,...
        ...
        bc_data.handles.to_move = [  axis1_menu, axis1_text1, axis1_text2, axis1_obj1_menu, axis1_obj2_menu,  axis1_point1_menu, axis1_point2_menu,...
            ...
            orig_text, axis3_obj3_menu, axis3_point3_menu, bc_obj_text, bc_obj_menu, instruct_text];
