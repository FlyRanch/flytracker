...
% 
% Description:    This function is called when the edit box for the z axis
...
edit_value = str2num(get(data.handles.z_edit,'String'));
set(data.handles.z_slider,'Value',edit_value);
