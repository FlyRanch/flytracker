...
for i=1:NOV,
    ...
    % linearize FFUN
    [A,G] = feval(InferenceDS.linearize, InferenceDS, state, pNoise.mu, oNoise.mu, UU1, UU2, 'A','G');
    ...
    % linearize HFUN
    [C,H] = feval(InferenceDS.linearize, InferenceDS, xh_(:,i), pNoise.mu, oNoise.mu, UU1, UU2, 'C','H');
    ...
    case 'parameter'  %--- parameter estimation
        ...
        otherwise
            error(' [ekf] Unkown process noise adaptation method!');
        end
