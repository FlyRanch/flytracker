...
for j=1:NOV,
    ...
    processNoise = feval(pNoise.sample, pNoise, N);
    particlesPred = feval(InferenceDS.ffun, InferenceDS, particles, processNoise, UU1);
    ...
    likelihood = feval(InferenceDS.likelihood, InferenceDS, OBS, particlesPred, UU2, oNoise) + 1e-99;
    ...
    if (0)
        prior = feval(InferenceDS.prior, InferenceDS, particlesPred, particles, UU1, pNoise) + 1e-99;
        figure(20);
        subplot(411)
        stem(prior);
        ylabel('prior');
    ...
    if pNoise.adaptMethod switch InferenceDS.inftype
            ...
            case 'parameter'  %--- parameter estimation
                switch pNoise.adaptMethod
                    ...
                    otherwise
                        error(' [pf] Unkown process noise adaptation method!');
                end
