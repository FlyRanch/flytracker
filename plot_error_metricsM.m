...
PAR.filetag = {'exp001000','exp098000','exp099000','exp100000','exp101000','exp102000','exp104000'};

PAR.solutionpath = [PAR.videopath '/solutions/'];
frgroup = {[450 549],[325 519],[90 425],[40 170],[90 402],[61 390],[800 1016]};

%These are the frames with regular wing beats used to fit a line through 
strokeReg = {[450 549],[325 519],[270 500],[40 170],[196 396],...
...
%pts)
FrameStart = [450 326 96 41 97 70 802];
interptag = 0;
%--------------------------------
...
%% ===============================================================
    ...
    load(['kine/SavedKinematics/Martin/manualfit_11_12_M_1.mat']);
