...
% cd '/home/florian/WORK/flytracker_original'
addpath(pwd);
addpath('/home/matt/Dropbox/WORK/flytracker_original/mex/');
addpath('/home/matt/Dropbox/WORK/flytracker_original/core/');
...
startpath = '/home/matt/DATA/solutions';
...
if getImageData
    ...
    if exist([PAR.solutionpath ['fly_' PAR.stub]],'dir') ~= 7
        ...
        %% FTMmod 20120612
        mkdir(PAR.solutionpath,['Images_' PAR.stub '/cam1']);
        mkdir(PAR.solutionpath,['Images_' PAR.stub '/cam2']);
        mkdir(PAR.solutionpath,['Images_' PAR.stub '/cam3']);
    end
...
% %% FTMmod 20120612 test
% startframe = 506;
% PAR.ICframe = 506;
% PAR.FileFromKine = 'kine_frame506ftm';
% %%
